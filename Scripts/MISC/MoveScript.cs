...
public class MoveScript : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        //rb.velocity = movement * MoveSpeed; // Bestemmer hastigheten du beverger deg i, og direksjonen ved å gange axis inputene med bevegelses hastigheten.
        rb.velocity += movement * MoveSpeed*MoveSpeed * acceleration*0.02f;
        rb.velocity -= rb.velocity * MoveSpeed * deceleration * 0.02f;

        if (movement != Vector2.zero) // bestemmer hvordan bil spriten skal rotere seg basert på veien du kjører
        {
